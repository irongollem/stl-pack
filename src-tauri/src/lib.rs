...
use catalog::commands::{
    ...
    dismiss_base_suggestion, ensure_model_files, finalize_normalize, flatten_catalog_group,
    ...
    get_model_geometry, get_pack_candidates, get_recommended_edge_cap, get_render_candidates,
    list_catalog_roots,
